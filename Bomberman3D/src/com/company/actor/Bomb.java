...
//	protected Image img;
	...
	public Bomb(int x, int y, int size, int timeline){
		...
		this.y=y;
		this.size=size;
		this.orient=0;			//định hướng
		this.timeline = timeline;
		this.typeActor = Actor.BOMB;
		img= new ImageIcon(getClass().getResource("/Images/bomb.gif")).getImage();			//sử dụng ImageIcon để hiển thị bomb trên background_Play
...
//			else if(actor.getType()==Bomber.SOOT) {
//				return 3;
//			}
//			else if(actor.getType()==Bomber.PIRATE) {
//				return 4;
//			}
			return 1;
		}
